...
def send_mails(pk, headline, subscribers_emails):
...
def post_add_notification(pk):
    ...
    send_mails(adv.pk, adv.headline, subscribers_emails)
...
def my_job():
    ...
    ads = Advertisement.objects.filter(datetime_in__gte=week_ago)
